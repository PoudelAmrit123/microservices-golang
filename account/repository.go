...
func (r *postgressRepository) Ping() error {
	return r.db.Ping()
}

func (r *postgressRepository) PutAccount(ctx context.Context, a Account) error {
...
func (r *postgressRepository) ListAccounts(ctx context.Context, skip uint64, take uint64) ([]Account, error) {
