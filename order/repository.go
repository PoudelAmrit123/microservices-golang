...
func (r *postgresRepository) PutOrder(ctx context.Context, order Order) error {
	...
	_, err = tx.ExecContext(ctx,
		"INSERT INTO orderes (id , created_at , account_id , total_price) VALUES ($1 , $2  ,$3 , $4)", order.ID, order.CreatedAt, order.AccountID, order.TotalPrice,
	)
	if err != nil {
		return err
	}

	//*Inserting the Order Products that come in the Order request
